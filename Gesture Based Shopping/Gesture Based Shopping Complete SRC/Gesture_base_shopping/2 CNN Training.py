...
train_images, train_labels = load_dataset('GESTURE DATASET/train')
test_images, test_labels = load_dataset('GESTURE DATASET/test')
...
model_info = None
try:
  model.load_weights('new_model_CNN_100.h5')
except:
  ...
  model.save_weights('new_model_CNN_100.h5')
